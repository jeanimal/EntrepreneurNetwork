      ...
      <Link href="/">
        <div className={`flex items-center justify-center cursor-pointer`}>
          <svg width={width} height={height} viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
            {/* Star-like splash with thicker ragged edges and grey outline */}
            <path 
              d="M20,5.5c2.1,0,2.7,2.4,3.5,4.1c1.1,2.2,2.9,2.3,5.1,2.3c2.7,0,5.5-0.2,6.9,2.5
              ...
              c-2-1.6-3.6-3.5-2.9-6.3c0.6-2.5,3-3.2,5.3-3.7c2.2-0.4,3.3-1.9,3.9-3.9C19.9,9.7,17.7,5.5,20,5.5z"
              fill="#FFD6E0"
              stroke="#888888"
              strokeWidth="0.8"
            />
