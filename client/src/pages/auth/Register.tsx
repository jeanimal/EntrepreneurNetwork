...
export default function Register() {
  ...
  const handleRegister = () => {
    login(); // This will redirect to /api/login which handles both registration and login
  };
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Sign up with your Replit account to connect with entrepreneurs and investors
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            ...
            After registering, you can set your user type (entrepreneur or investor) in your profile settings.
          </p>
        </CardContent>
      </Card>
    </div>
